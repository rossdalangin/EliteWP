...
<section class="agitation-section section bg-dots" id="agitation" style="background: var(--color-white);">
    <div class="container">
        <div class="section-header text-center" data-reveal>
            <span class="step-number" style="background: var(--color-primary); color: white;"><?php esc_html_e( 'OPERATIONAL FRICTION', 'premium-b2b' ); ?></span>
        ...
        <div class="grid agitation-grid">
            ...
            ?>
                <div class="card agitation-card" data-reveal>
                    <div class="icon" style="background: var(--color-bg); width: 6rem; height: 6rem; display: flex; align-items: center; justify-content: center; border-radius: 1.5rem; font-size: 2.5rem; margin-bottom: var(--sp-6); border: 1px solid var(--color-border);"><?php echo $agitation_defaults[$i]['i']; ?></div>
                    <h3 style="font-size: var(--fs-md); margin-bottom: var(--sp-4);"><?php echo esc_html( $title ); ?></h3>
                    <p class="text-light" style="font-size: var(--fs-sm); font-weight: 500;"><?php echo esc_html( $desc ); ?></p>
                </div>
            <?php endfor; ?>
        </div>
    </div>
