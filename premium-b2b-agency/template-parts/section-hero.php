...
<section class="hero-section section bg-grid" fetchpriority="high">
    <div class="container grid" style="grid-template-columns: 1.2fr 0.8fr;">
        <div class="hero-content" data-reveal>
            <div class="hero-highlights flex" style="margin-bottom: 3.5rem; gap: 3rem;">
                <?php
                ...
                for($i=1; $i<=3; $i++):
                    ...
                    if($h):
                ?>
                    <span class="text-accent" style="font-size: var(--fs-xs); font-weight: 900; text-transform: uppercase; letter-spacing: 0.2em; display: flex; align-items: center; gap: 1rem;">
                        <span style="width: 10px; height: 10px; background: var(--color-accent); border-radius: 50%; box-shadow: 0 0 15px var(--color-accent);"></span>
                        <?php echo esc_html($h); ?>
                    </span>
                <?php endif; endfor; ?>
            </div>
            <h1 itemprop="name" style="margin-bottom: 3.5rem; line-height: 0.9;">
                <?php echo esc_html( get_theme_mod( 'hero_headline', 'Scale Your B2B Agency with Precision Acquisition' ) ); ?>
            </h1>
            <p class="text-light" itemprop="description" style="font-size: var(--fs-md); max-width: 65ch; margin-bottom: 5rem; line-height: 1.8; font-weight: 500;">
            ...
            <div class="hero-cta flex" style="gap: 3rem; flex-wrap: wrap;">
                ...
                <a href="#mechanism" class="btn" style="border-bottom: 3px solid var(--color-accent); border-radius: 0; padding-inline: 0; font-weight: 900; letter-spacing: 0.1em; font-size: var(--fs-xs);">
                    <?php esc_html_e( 'EXPLORE THE FRAMEWORK', 'premium-b2b' ); ?>
                </a>
            </div>
        </div>
        <div class="hero-graphic hidden-mobile" data-reveal>
            <div class="hero-graphic-wrapper" style="transform: perspective(2000px) rotateY(-15deg) rotateX(5deg); transform-style: preserve-3d;">
